...
//                    updateCarrierLabelVisibility(false);
    ...
    public void setClockStatus(int width, int mode, boolean enabled) {
        if (mNotificationIcons != null) {
            mNotificationIcons.setClockStatus(width, mode, enabled);
        }
        mClockLocation = mode;
        mShowClock = enabled;
    }
    ...
    final int FLIP_DURATION_OUT = 60;
    final int FLIP_DURATION_IN = 120;

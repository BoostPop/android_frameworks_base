...
public class LteTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        // we build for N4 and N5, 
	// test if this test is necessary
        if (deviceSupportsLte(mContext)) {
            state.visible = false;
            return;
        }

        state.label = mContext.getString(R.string.quick_settings_lte_tile_label);
